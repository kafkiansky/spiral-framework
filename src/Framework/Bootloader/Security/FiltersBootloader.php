...
final class FiltersBootloader extends Bootloader implements Container\InjectorInterface, Container\SingletonInterface
{
    ...
    /**
     * @param class-string<CoreInterceptorInterface> $interceptor
     */
    public function addInterceptor(string $interceptor): void
    {
        $this->config->modify(
            FiltersConfig::CONFIG,
            new Append('interceptors', key: null, value: $interceptor)
        );
    }
    ...
    private function initFilterProvider(Container $container, FiltersConfig $config): FilterProviderInterface
    {
